...
import 'package:flutter_http_demo/data/api/product_api.dart';
import 'package:flutter_http_demo/models/category.dart';
...
class MainScreenState extends State {
  ...
  List<Widget> caategoryWidgets = List<Widget>();
        ...
        child: Column(
          children: <Widget>[
            SingleChildScrollView(
              ...
              child: Row(children: caategoryWidgets),
            ),
  ...
  List<Widget> getCategoryWidgets() {
    for (int i = 0; i < categories.length; i++) {
      caategoryWidgets.add(getCategoryWidget(categories[i]));
    }
    return caategoryWidgets;
  }

  Widget getCategoryWidget(Category category) {
    return FlatButton(
      onPressed: () {
        print("Seçilen kategori: " + category.categoryName);
